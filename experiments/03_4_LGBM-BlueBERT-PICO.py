...
experiment_name = "03d : LGBM - BlueBERT Similarity PICO"
target = "Decision"
...
df = pd.read_csv( project.get_dataset("pico_similarity"), low_memory=False )
...
features = ['Age','title_length','abstract_length','TEXT_length',
       ...
       'O_TEXT_ji', 'O_TEXT_sd',
       'similarity_TEXT__P','similarity_TEXT__I','similarity_TEXT__C','similarity_TEXT__O']
