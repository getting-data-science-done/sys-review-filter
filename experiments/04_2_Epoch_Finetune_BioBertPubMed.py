...
experiment_name = "04a : BERT - 02e - BioBERT:PubMed"
target = "Decision"
...
for study in studies:
    ...
    checkpoint_path ='./checkpoints/BioBERT_' + study + '_1e/' + checkpnt 
    model = AutoModelForSequenceClassification.from_pretrained(checkpoint_path)

    training_args = TrainingArguments(
        output_dir='./checkpoints/BioBERT_'+study+'_2e',          # output directory
