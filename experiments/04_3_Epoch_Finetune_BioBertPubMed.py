...
experiment_name = "04a : BERT - 03e - BioBERT:PubMed"
target = "Decision"
...
checkpoints = {
"CARGEL":"checkpoint-3500",
"CIDP":  "checkpoint-3500",
"EMR":   "checkpoint-3500", 
"ESG":   "checkpoint-3500", 
"IORT":  "checkpoint-4000", 
"LANB":  "checkpoint-4000", 
"LMTA":  "checkpoint-4000", 
"PBRT":  "checkpoint-4000", 
"VERT":  "checkpoint-4000",
"PID":   "checkpoint-2500"
}
...
for study in studies:
    ...
    checkpnt = checkpoints[study]
    checkpoint_path ='./checkpoints/BioBERT_' + study + '_2e/' + checkpnt 
    model = AutoModelForSequenceClassification.from_pretrained(checkpoint_path)

    training_args = TrainingArguments(
        output_dir='./checkpoints/BioBERT_'+study+'_3e',          # output directory
