...
experiment_name = "02b : LGBM - TFID - PICO"
target = "Decision"
...
for study in studies:
    ...
    #shap_plot = "results/LGBM_FeatureImportance_%s.png" % study
    #print("Creating:", shap_plot)
    #explainer.plot_shap_values(x_test, shap_plot, 100)
    #shap_plot = "results/LGBM_Beeswarm_%s.png" % study
    #print("Creating:", shap_plot)
    #explainer.beeswarm_plot(x_test, shap_plot, 100)
