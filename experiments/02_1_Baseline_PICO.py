...
experiment_name = "00b : Linear Baseline PICO" 
target = "Decision"
...
features = ['Age','title_length','abstract_length','TEXT_length',
       ...
       'TEXT_wc','TEXT_max_wl','TEXT_avg_wl','TEXT_cwd','author_count',
...
for study in studies:
    ...
    model = Pipeline(steps=[
        ...
        ('regressor', LogisticRegression(random_state=0, solver='saga', penalty='elasticnet', l1_ratio=0.2, max_iter=8000) )
    ])
