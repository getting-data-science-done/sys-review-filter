...
def process_data(data_path, model, text_col, question_col):
    ...
    df2 = add_similarity_feature(df, model, text_col, "P")
    df3 = add_similarity_feature(df2, model, text_col, "I")
    df4 = add_similarity_feature(df3, model, text_col, "C")
    df5 = add_similarity_feature(df4, model, text_col, "O")
    return df5
